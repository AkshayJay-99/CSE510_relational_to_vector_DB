...
class LSHFHeaderPage extends HFPage {
  ...
  private HashMap<Integer, PageId> hashBucketTable;
  ...
  public HashMap<Integer, PageId> getHashBucketTable()
  {
    return this.hashBucketTable;
  }


  public void setHashBucketTable(HashMap<Integer, PageId> table)
  {
