...
/**
 * Stores a 100D vector into the given byte array at the specified position.
 * @param value The Vector100Dtype to store.
 * @param position The byte position where the vector should be written.
 * @param data The byte array (HFPage data) to write to.
 ...
 * @param data The byte array (HFPage data) to read from.
 * @return The extracted Vector100Dtype.
 * @throws IOException If an I/O error occurs.
 */
public Vector100Dtype get100DVectorValue(int position, byte[] data) throws IOException {
  ...
  public Tuple getRecord(RID rid) throws IOException, InvalidSlotNumberException {
    ...
    if (slotNo >= 0 && slotNo < slotCnt && recLen > 0 && pageNo.pid == curPage.pid) {
        ...
        // Convert the data into a Tuple object
