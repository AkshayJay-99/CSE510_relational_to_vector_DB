  ...
  {           
   ...
   public char getCharFld(int fldNo) 
    ...
    {   
     ...
     /**
    * Checks if the given field number contains a Vector100Dtype.
    * @param fldNo The field number to check.
    * @param types The attribute types of the tuple.
    * @return true if the field is of type Vector100Dtype, false otherwise.
    */
    public boolean hasVector100DField(int fldNo, AttrType[] types) {
      if (fldNo > 0 && fldNo <= fldCnt) {
          return types[fldNo - 1].attrType == AttrType.attrVector100D;
      }
      return false;
  }
      ...
      throws IOException, FieldNumberOutOfBoundException 
 {
  ...
  for (i=0; i< fldCnt-1; i++)
   ...
   case AttrType.attrString:
     ...
     break;
   case AttrType.attrVector100D:
    Vector100Dtype vector = get100DVectorFld(i + 1);
